...
HD_PWD='C:/Users/Ethan/OneDrive/Documents/CPE233/BAG/BAG.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BAG.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BAG.tcl
