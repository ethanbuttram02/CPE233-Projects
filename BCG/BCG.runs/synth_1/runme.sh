...
HD_PWD='C:/Users/Ethan/OneDrive/Documents/CPE233/BCG/BCG.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BCG.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BCG.tcl
